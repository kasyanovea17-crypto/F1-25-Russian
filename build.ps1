...
$r=$PSScriptRoot
$out=Join-Path $r 'dist\F1_25_RU_v0.25'
$zip=Join-Path $r 'dist\F1_25_RU_v0.25_text0.15.5.zip'
...
foreach($n in @('Launcher.cs','Updater.cs','Engine.ps1','Compatibility.cs','background.png','project-links.json','EDITORIAL_NOTES.json','README.txt','CHANGELOG.md','Вернуть оригинал.cmd')){
...
Write-Output ('BUILD_PASS launcher=0.25 text='+$m.text_version)
