...
$r=$PSScriptRoot
$out=Join-Path $r 'dist\F1_25_RU_v0.22'
...
Compress-Archive -LiteralPath $out -DestinationPath (Join-Path $r 'dist\F1_25_RU_v0.22.zip')
Write-Output 'BUILD_PASS launcher=0.22'
